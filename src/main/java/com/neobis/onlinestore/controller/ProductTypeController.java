...
public class ProductTypeController {
    ...
    public String updateProductType(@RequestParam @NotBlank String name) {
        return productTypeService.updateProductType(name);
    }

    @DeleteMapping
    @Operation(summary = "Delete product type", description = "Deleting product type")
    public String deleteProductType(@Positive Long id) {
    ...
    @GetMapping("/{id}")
    @Operation(summary = "Get product type", description = "Getting product types")
    public ProductTypeResponse getAllProductTypes(@Positive @PathVariable("id") Long id) {
